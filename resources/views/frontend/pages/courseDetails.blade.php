...
?>
<!--end navbar-->
<!-- <a href="#" title="Facebook" class="btn btn-facebook btn-lg"></a> -->
<div id="fixed-social">
  <div>
...
<!-- <div class="btn-group" role="group" aria-label="...">
    ...
    <div class="fb-share-button" data-href="https://developers.facebook.com/docs/plugins/" data-layout="button_count" data-size="small"><a target="_blank" href="https://www.facebook.com/sharer/sharer.php?u={{ url()->current() }}" class="fb-xfbml-parse-ignore btn btn-info btn-lg"><i class="fab fa-facebook-f" style="margin-right: 5px;"></i> Share</a></div>
...
<a class="twitter-share-button btn btn-tweeter btn-lg"
  href="https://twitter.com/intent/tweet?text={{ url()->current() }}"
  data-size="large">
Share</a>
 -->
...
<div class="col-lg-12 mt-5 pb-5">
    ...
    ?>
        <div class="col-md-3 mx-auto mt-md-5 pb-md-4 mb-md-5 my-2 pb-2 text-center">
            <!-- <a href="<?php //echo url('course-details/'.$course->id.'/checkout');?>"> -->
