...
<!-- <section class="slider-section bg-pink">
  <br><br>
  <div class="">
        ...
        <div class="tc">
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="row">
                <div class="col-md-6">
                  <div class="slider-content px-5">
                    <h5>Women in Digital is an all-star team of female technologists dedicated to bringing more Bangladeshi women into the digital economy.</h5>
                ...
                <div class="col-md-6">
                  ...
                  <div class="video-section-slider">
                    <img src="{{url('frontend/assets/imgs/vedio_image.jpg')}}" alt="" class="img-fluid">
                      ...
                      <div class="modal-dialog custom-modal-dailog" role="document">
                        <div class="modal-content">
                          <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Women In digital</h5>
...
<section class="video-block bg-pink">
  <div class="container">
    ...
    <div class="video-tab clearfix" style="">
...
<div class="tab-pane fade custom-tab-pane-step" id="videoTab0edit">
               <video width="560" height="315" controls>
                ...
                <source src="{{url('frontend/assets/imgs/video-image/video506c7ae5-63d0-44d7-8786-75e7d52acc66video.mp4')}}" type="video/ogg">
          ...
          <ul class="nav nav-tabs">
            <li class="active">
              <a href="#videoTab01" data-toggle="tab">
                ...
                <h3>2020 Inclusive Internet Index Documentary Film on Women in Digital, Powered By Facebook
</h3>
              </a>
            </li>
            <li>
      ...
      <div class="col-lg-6 col-xs-12 white-bg" style="">
        <div class="for-japanes-learner">
          ...
          <ul>
            ...
            <li> <span><i class="fas fa-check"></i></span>Contribute on young people education with your experience and knowledge through language learning</li>
